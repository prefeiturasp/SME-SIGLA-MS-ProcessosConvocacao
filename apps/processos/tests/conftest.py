...
@pytest.fixture
def processo_convocacao(usuario):
...
@pytest.fixture
def processos_multiplos(usuario):
...
@pytest.fixture
def processo_finalizado(usuario):
...
@pytest.fixture
def processo_cancelado(usuario):
...
@pytest.fixture
def processo_avaliacao(usuario):
