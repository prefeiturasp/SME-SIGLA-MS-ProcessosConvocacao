...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Raises:
            Nenhuma exceção específica documentada.
        """
        quantidade = options["count"]
        cargos_por_processo = options["cargos_per_processo"]

        self.stdout.write(
            self.style.SUCCESS(
                f"Criando {quantidade} processos com {cargos_por_processo} cargos cada..."  # noqa: E501
            )
        )
        ...
        concursos_disponiveis = [
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso Nacional de Tecnologia da Informação",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Seleção Pública para Desenvolvedores",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso Estadual de Analistas de Sistemas",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Processo Seletivo para DevOps Engineers",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso Municipal de Desenvolvedores Web",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Seleção para Arquiteto de Software",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso Federal de Analistas de Dados",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Processo Seletivo para QA Engineers",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso de Desenvolvedores Mobile",
            },
            {"uuid": uuid.uuid4(), "nome": "Seleção para Tech Lead"},
            {"uuid": uuid.uuid4(), "nome": "Concurso de Product Managers"},
            {
                "uuid": uuid.uuid4(),
                "nome": "Processo Seletivo para UX/UI Designers",
            },
            ...
            {
                "uuid": uuid.uuid4(),
                "nome": "Processo Seletivo para Full Stack Developers",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso de Desenvolvedores Backend",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Seleção para Desenvolvedores Frontend",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Concurso de Analistas de Infraestrutura",
            },
            {
                "uuid": uuid.uuid4(),
                "nome": "Processo Seletivo para Especialistas em Cloud",
            },
        ]

        self.stdout.write(
            self.style.SUCCESS(
                f"📋 {len(concursos_disponiveis)} concursos disponíveis para seleção aleatória"  # noqa: E501
            )
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"👥 {len(cargos_exemplo)} cargos disponíveis com UUIDs fixos"
            )
        )
        ...
        for _i in range(quantidade):
            ...
            descricoes = {
                "Nova Autorização": "Convocatório para nova autorização de profissionais",  # noqa: E501
                "Reposição": "Processo seletivo para reposição de candidatos",
                "Reconvocação": "Avaliação técnica para reconvocação de especialistas",  # noqa: E501
            }
            descricao = descricoes.get(
                random_tipo, f"Processo de {random_tipo.lower()}"
            )

            # Gerar data de convocação aleatória entre 2 e 30 dias a partir de hoje  # noqa: E501
            dias_aleatorios = random.randint(2, 30)
            data_convocacao = timezone.now() + timezone.timedelta(
            ...
            cargos_para_processo = random.sample(
                cargos_exemplo, min(cargos_por_processo, len(cargos_exemplo))
            )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"\n📊 Total: {len(processos_criados)} processos + {len(cargos_criados)} cargos"  # noqa: E501
            )
        )
