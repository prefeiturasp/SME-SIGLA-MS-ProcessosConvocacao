...
def test_processo_convocacao_creation(processo_convocacao, concurso_uuid, concurso_nome):
...
def test_processo_convocacao_meta_options(processo_convocacao):
    ...
    assert processo_convocacao._meta.verbose_name_plural == "Processos de Convocação"
